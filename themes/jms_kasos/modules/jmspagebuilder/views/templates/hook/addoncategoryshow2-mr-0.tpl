...
<script type="text/javascript">
	var cs_mr0_items = {if $cols}{$cols|escape:'htmlall':'UTF-8'}{else}4{/if};
	var cs_mr0_itemsDesktop = {if $cols}{$cols|escape:'htmlall':'UTF-8'}{else}4{/if};
	var cs_mr0_itemsDesktopSmall = {if $cols_md}{$cols_md|escape:'htmlall':'UTF-8'}{else}3{/if};
	var cs_mr0_itemsTablet = {if $cols_sm}{$cols_sm|escape:'htmlall':'UTF-8'}{else}2{/if};
	var cs_mr0_itemsMobile = {if $cols_xs}{$cols_xs|escape:'htmlall':'UTF-8'}{else}1{/if};
	var cs_mr0_nav = {if $navigation == 1}true{else}false{/if};
	var cs_mr0_pag = {if $pagination == 1}true{else}false{/if};
	var cs_mr0_auto_play_carousel = {if $autoplay == 1}true{else}false{/if};
</script>
{if $addon_title}
